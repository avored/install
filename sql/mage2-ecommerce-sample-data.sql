...
--
-- Table structure for table `mage2_addresses`
--

DROP TABLE IF EXISTS `mage2_addresses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_addresses` (
  ...
  CONSTRAINT `addresses_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `mage2_countries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `addresses_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `mage2_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_addresses`
--

LOCK TABLES `mage2_addresses` WRITE;
/*!40000 ALTER TABLE `mage2_addresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_addresses` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_admin_password_resets`
--

DROP TABLE IF EXISTS `mage2_admin_password_resets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_admin_password_resets` (
...
--
-- Dumping data for table `mage2_admin_password_resets`
--

LOCK TABLES `mage2_admin_password_resets` WRITE;
/*!40000 ALTER TABLE `mage2_admin_password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_admin_password_resets` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_admin_users`
--

DROP TABLE IF EXISTS `mage2_admin_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_admin_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mage2_admin_users`
--

LOCK TABLES `mage2_admin_users` WRITE;
/*!40000 ALTER TABLE `mage2_admin_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_admin_users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_attribute_dropdown_options`
--

DROP TABLE IF EXISTS `mage2_attribute_dropdown_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_attribute_dropdown_options` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `attribute_dropdown_options_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_attribute_dropdown_options`
--

LOCK TABLES `mage2_attribute_dropdown_options` WRITE;
/*!40000 ALTER TABLE `mage2_attribute_dropdown_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_attribute_dropdown_options` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_attribute_product`
--

DROP TABLE IF EXISTS `mage2_attribute_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_attribute_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `attribute_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `attribute_product_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `attribute_product_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_attribute_product`
--

LOCK TABLES `mage2_attribute_product` WRITE;
/*!40000 ALTER TABLE `mage2_attribute_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_attribute_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_attributes`
--

DROP TABLE IF EXISTS `mage2_attributes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_attributes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mage2_attributes`
--

LOCK TABLES `mage2_attributes` WRITE;
/*!40000 ALTER TABLE `mage2_attributes` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_attributes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_categories`
--

DROP TABLE IF EXISTS `mage2_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mage2_categories`
--

LOCK TABLES `mage2_categories` WRITE;
/*!40000 ALTER TABLE `mage2_categories` DISABLE KEYS */;
INSERT INTO `mage2_categories` VALUES (1,NULL,'Kitchen','kitchen',NULL,NULL,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(2,NULL,'Bedroom','bedroom',NULL,NULL,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(3,NULL,'Living Room','living-room',NULL,NULL,'2018-02-23 10:22:07','2018-02-23 10:22:07');
/*!40000 ALTER TABLE `mage2_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_category_product`
--

DROP TABLE IF EXISTS `mage2_category_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_category_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `category_product_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `mage2_categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `category_product_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_category_product`
--

LOCK TABLES `mage2_category_product` WRITE;
/*!40000 ALTER TABLE `mage2_category_product` DISABLE KEYS */;
INSERT INTO `mage2_category_product` VALUES (1,3,1,NULL,NULL),(2,3,2,NULL,NULL),(3,3,3,NULL,NULL),(4,3,4,NULL,NULL),(5,3,5,NULL,NULL),(7,2,6,NULL,NULL),(8,2,8,NULL,NULL),(9,2,9,NULL,NULL),(10,2,10,NULL,NULL),(11,1,11,NULL,NULL),(12,1,12,NULL,NULL),(13,1,13,NULL,NULL),(14,1,14,NULL,NULL);
/*!40000 ALTER TABLE `mage2_category_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_configurations`
--

DROP TABLE IF EXISTS `mage2_configurations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_configurations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mage2_configurations`
--

LOCK TABLES `mage2_configurations` WRITE;
/*!40000 ALTER TABLE `mage2_configurations` DISABLE KEYS */;
INSERT INTO `mage2_configurations` VALUES (1,'general_site_title','Mage2 Laravel Ecommerce','2018-02-23 10:10:32','2018-02-23 10:10:32'),(2,'general_site_description','Mage2 Laravel Ecommerce','2018-02-23 10:10:32','2018-02-23 10:10:32'),(3,'mage2_tax_class_default_country_for_tax_calculation','141','2018-02-23 10:10:32','2018-02-23 10:10:32'),(4,'general_home_page','1','2018-02-23 10:22:07','2018-02-23 10:22:07'),(5,'general_term_condition_page','2','2018-02-23 10:22:07','2018-02-23 10:22:07');
/*!40000 ALTER TABLE `mage2_configurations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_countries`
--

DROP TABLE IF EXISTS `mage2_countries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_countries` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mage2_gift_coupons`
--

LOCK TABLES `mage2_gift_coupons` WRITE;
/*!40000 ALTER TABLE `mage2_gift_coupons` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_gift_coupons` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_migrations`
--

DROP TABLE IF EXISTS `mage2_migrations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_migrations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mage2_migrations`
--

LOCK TABLES `mage2_migrations` WRITE;
/*!40000 ALTER TABLE `mage2_migrations` DISABLE KEYS */;
INSERT INTO `mage2_migrations` VALUES (1,'2017_03_29_000000_mage2_ecommerce_schema',1);
/*!40000 ALTER TABLE `mage2_migrations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_oauth_access_tokens`
--

DROP TABLE IF EXISTS `mage2_oauth_access_tokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_oauth_access_tokens` (
...
--
-- Dumping data for table `mage2_oauth_access_tokens`
--

LOCK TABLES `mage2_oauth_access_tokens` WRITE;
/*!40000 ALTER TABLE `mage2_oauth_access_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_oauth_access_tokens` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_oauth_auth_codes`
--

DROP TABLE IF EXISTS `mage2_oauth_auth_codes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_oauth_auth_codes` (
  `id` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `mage2_oauth_auth_codes`
--

LOCK TABLES `mage2_oauth_auth_codes` WRITE;
/*!40000 ALTER TABLE `mage2_oauth_auth_codes` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_oauth_auth_codes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_oauth_clients`
--

DROP TABLE IF EXISTS `mage2_oauth_clients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_oauth_clients` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `mage2_oauth_clients`
--

LOCK TABLES `mage2_oauth_clients` WRITE;
/*!40000 ALTER TABLE `mage2_oauth_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_oauth_clients` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_oauth_personal_access_clients`
--

DROP TABLE IF EXISTS `mage2_oauth_personal_access_clients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_oauth_personal_access_clients` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `mage2_oauth_personal_access_clients`
--

LOCK TABLES `mage2_oauth_personal_access_clients` WRITE;
/*!40000 ALTER TABLE `mage2_oauth_personal_access_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_oauth_personal_access_clients` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_oauth_refresh_tokens`
--

DROP TABLE IF EXISTS `mage2_oauth_refresh_tokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_oauth_refresh_tokens` (
  `id` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `mage2_oauth_refresh_tokens`
--

LOCK TABLES `mage2_oauth_refresh_tokens` WRITE;
/*!40000 ALTER TABLE `mage2_oauth_refresh_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_oauth_refresh_tokens` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_order_product`
--

DROP TABLE IF EXISTS `mage2_order_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_order_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `order_product_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `mage2_orders` (`id`),
  CONSTRAINT `order_product_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_order_product`
--

LOCK TABLES `mage2_order_product` WRITE;
/*!40000 ALTER TABLE `mage2_order_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_order_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_order_product_variations`
--

DROP TABLE IF EXISTS `mage2_order_product_variations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_order_product_variations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `attribute_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `order_product_variations_attribute_dropdown_option_id_foreign` FOREIGN KEY (`attribute_dropdown_option_id`) REFERENCES `mage2_attribute_dropdown_options` (`id`),
  CONSTRAINT `order_product_variations_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`),
  CONSTRAINT `order_product_variations_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `mage2_orders` (`id`),
  CONSTRAINT `order_product_variations_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_order_product_variations`
--

LOCK TABLES `mage2_order_product_variations` WRITE;
/*!40000 ALTER TABLE `mage2_order_product_variations` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_order_product_variations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_order_statuses`
--

DROP TABLE IF EXISTS `mage2_order_statuses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_order_statuses` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `mage2_order_statuses`
--

LOCK TABLES `mage2_order_statuses` WRITE;
/*!40000 ALTER TABLE `mage2_order_statuses` DISABLE KEYS */;
INSERT INTO `mage2_order_statuses` VALUES (1,'Pending',1,NULL,NULL),(2,'Delivered',0,NULL,NULL),(3,'Received',0,NULL,NULL),(4,'Canceled',0,NULL,NULL);
/*!40000 ALTER TABLE `mage2_order_statuses` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_orders`
--

DROP TABLE IF EXISTS `mage2_orders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_orders` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `orders_billing_address_id_foreign` FOREIGN KEY (`billing_address_id`) REFERENCES `mage2_addresses` (`id`),
  CONSTRAINT `orders_order_status_id_foreign` FOREIGN KEY (`order_status_id`) REFERENCES `mage2_order_statuses` (`id`),
  CONSTRAINT `orders_shipping_address_id_foreign` FOREIGN KEY (`shipping_address_id`) REFERENCES `mage2_addresses` (`id`),
  CONSTRAINT `orders_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `mage2_users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_orders`
--

LOCK TABLES `mage2_orders` WRITE;
/*!40000 ALTER TABLE `mage2_orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_pages`
--

DROP TABLE IF EXISTS `mage2_pages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_pages` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `mage2_password_resets`
--

LOCK TABLES `mage2_password_resets` WRITE;
/*!40000 ALTER TABLE `mage2_password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_password_resets` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_permission_role`
--

DROP TABLE IF EXISTS `mage2_permission_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_permission_role` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `permission_role_permission_id_foreign` FOREIGN KEY (`permission_id`) REFERENCES `mage2_permissions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `permission_role_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `mage2_roles` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_permission_role`
--

LOCK TABLES `mage2_permission_role` WRITE;
/*!40000 ALTER TABLE `mage2_permission_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_permission_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_permissions`
--

DROP TABLE IF EXISTS `mage2_permissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_permissions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `mage2_permissions`
--

LOCK TABLES `mage2_permissions` WRITE;
/*!40000 ALTER TABLE `mage2_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_permissions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_attribute_boolean_values`
--

DROP TABLE IF EXISTS `mage2_product_attribute_boolean_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_attribute_boolean_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `attribute_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `product_attribute_boolean_values_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_attribute_boolean_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_attribute_boolean_values`
--

LOCK TABLES `mage2_product_attribute_boolean_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_attribute_boolean_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_attribute_boolean_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_attribute_datetime_values`
--

DROP TABLE IF EXISTS `mage2_product_attribute_datetime_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_attribute_datetime_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `attribute_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `product_attribute_datetime_values_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_attribute_datetime_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_attribute_datetime_values`
--

LOCK TABLES `mage2_product_attribute_datetime_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_attribute_datetime_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_attribute_datetime_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_attribute_decimal_values`
--

DROP TABLE IF EXISTS `mage2_product_attribute_decimal_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_attribute_decimal_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `attribute_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `product_attribute_decimal_values_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_attribute_decimal_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_attribute_decimal_values`
--

LOCK TABLES `mage2_product_attribute_decimal_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_attribute_decimal_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_attribute_decimal_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_attribute_integer_values`
--

DROP TABLE IF EXISTS `mage2_product_attribute_integer_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_attribute_integer_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `attribute_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `product_attribute_integer_values_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_attribute_integer_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_attribute_integer_values`
--

LOCK TABLES `mage2_product_attribute_integer_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_attribute_integer_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_attribute_integer_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_attribute_text_values`
--

DROP TABLE IF EXISTS `mage2_product_attribute_text_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_attribute_text_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `attribute_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `product_attribute_text_values_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_attribute_text_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_attribute_text_values`
--

LOCK TABLES `mage2_product_attribute_text_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_attribute_text_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_attribute_text_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_attribute_varchar_values`
--

DROP TABLE IF EXISTS `mage2_product_attribute_varchar_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_attribute_varchar_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `attribute_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `product_attribute_varchar_values_attribute_id_foreign` FOREIGN KEY (`attribute_id`) REFERENCES `mage2_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_attribute_varchar_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_attribute_varchar_values`
--

LOCK TABLES `mage2_product_attribute_varchar_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_attribute_varchar_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_attribute_varchar_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_images`
--

DROP TABLE IF EXISTS `mage2_product_images`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_images` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `product_id` int(10) unsigned NOT NULL,
...
CREATE TABLE `mage2_product_prices` (
  ...
  CONSTRAINT `product_prices_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_prices`
--

LOCK TABLES `mage2_product_prices` WRITE;
/*!40000 ALTER TABLE `mage2_product_prices` DISABLE KEYS */;
INSERT INTO `mage2_product_prices` VALUES (1,1,80.200000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(2,2,30.900000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(3,3,90.400000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(4,4,80.200000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(5,5,80.900000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(6,6,90.700000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(7,6,60.800000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(8,8,80.900000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(9,9,100.800000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(10,10,80.500000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(11,11,70.200000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(12,12,30.100000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(13,13,40.600000,'2018-02-23 10:22:07','2018-02-23 10:22:07'),(14,14,30.200000,'2018-02-23 10:22:07','2018-02-23 10:22:07');
/*!40000 ALTER TABLE `mage2_product_prices` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_property_boolean_values`
--

DROP TABLE IF EXISTS `mage2_product_property_boolean_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_property_boolean_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `product_property_boolean_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_property_boolean_values_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `mage2_properties` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_property_boolean_values`
--

LOCK TABLES `mage2_product_property_boolean_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_property_boolean_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_property_boolean_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_property_datetime_values`
--

DROP TABLE IF EXISTS `mage2_product_property_datetime_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_property_datetime_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `property_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `value` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `product_property_datetime_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_property_datetime_values_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `mage2_properties` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_property_datetime_values`
--

LOCK TABLES `mage2_product_property_datetime_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_property_datetime_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_property_datetime_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_property_decimal_values`
--

DROP TABLE IF EXISTS `mage2_product_property_decimal_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_property_decimal_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `property_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `value` decimal(8,2) DEFAULT NULL,
  ...
  CONSTRAINT `product_property_decimal_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_property_decimal_values_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `mage2_properties` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_property_decimal_values`
--

LOCK TABLES `mage2_product_property_decimal_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_property_decimal_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_property_decimal_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_property_integer_values`
--

DROP TABLE IF EXISTS `mage2_product_property_integer_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_property_integer_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `property_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `value` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `product_property_integer_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_property_integer_values_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `mage2_properties` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_property_integer_values`
--

LOCK TABLES `mage2_product_property_integer_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_property_integer_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_property_integer_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_property_text_values`
--

DROP TABLE IF EXISTS `mage2_product_property_text_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_property_text_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `property_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `value` text COLLATE utf8_unicode_ci,
  ...
  CONSTRAINT `product_property_text_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_property_text_values_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `mage2_properties` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_property_text_values`
--

LOCK TABLES `mage2_product_property_text_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_property_text_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_property_text_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_property_varchar_values`
--

DROP TABLE IF EXISTS `mage2_product_property_varchar_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_property_varchar_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `property_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `product_property_varchar_values_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_property_varchar_values_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `mage2_properties` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_property_varchar_values`
--

LOCK TABLES `mage2_product_property_varchar_values` WRITE;
/*!40000 ALTER TABLE `mage2_product_property_varchar_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_property_varchar_values` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_product_variations`
--

DROP TABLE IF EXISTS `mage2_product_variations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_product_variations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `product_variations_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_variations_variation_id_foreign` FOREIGN KEY (`variation_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_product_variations`
--

LOCK TABLES `mage2_product_variations` WRITE;
/*!40000 ALTER TABLE `mage2_product_variations` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_product_variations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_products`
--

DROP TABLE IF EXISTS `mage2_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_products` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mage2_properties`
--

LOCK TABLES `mage2_properties` WRITE;
/*!40000 ALTER TABLE `mage2_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_properties` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_property_dropdown_options`
--

DROP TABLE IF EXISTS `mage2_property_dropdown_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_property_dropdown_options` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `property_id` int(10) unsigned NOT NULL,
  `display_text` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `property_dropdown_options_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `mage2_properties` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_property_dropdown_options`
--

LOCK TABLES `mage2_property_dropdown_options` WRITE;
/*!40000 ALTER TABLE `mage2_property_dropdown_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_property_dropdown_options` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_related_products`
--

DROP TABLE IF EXISTS `mage2_related_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_related_products` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `related_products_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `related_products_related_product_id_foreign` FOREIGN KEY (`related_product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_related_products`
--

LOCK TABLES `mage2_related_products` WRITE;
/*!40000 ALTER TABLE `mage2_related_products` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_related_products` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_reviews`
--

DROP TABLE IF EXISTS `mage2_reviews`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_reviews` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `reviews_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `reviews_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `mage2_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_reviews`
--

LOCK TABLES `mage2_reviews` WRITE;
/*!40000 ALTER TABLE `mage2_reviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_reviews` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_roles`
--

DROP TABLE IF EXISTS `mage2_roles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_roles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `mage2_roles`
--

LOCK TABLES `mage2_roles` WRITE;
/*!40000 ALTER TABLE `mage2_roles` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_roles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_states`
--

DROP TABLE IF EXISTS `mage2_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_states` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `country_id` int(10) unsigned NOT NULL,
  `code` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  CONSTRAINT `states_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `mage2_countries` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_states`
--

LOCK TABLES `mage2_states` WRITE;
/*!40000 ALTER TABLE `mage2_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_states` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_subscribers`
--

DROP TABLE IF EXISTS `mage2_subscribers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_subscribers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `mage2_subscribers`
--

LOCK TABLES `mage2_subscribers` WRITE;
/*!40000 ALTER TABLE `mage2_subscribers` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_subscribers` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_tax_group_tax_rule_pivot`
--

DROP TABLE IF EXISTS `mage2_tax_group_tax_rule_pivot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_tax_group_tax_rule_pivot` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `tax_group_tax_rule_pivot_tax_group_id_foreign` FOREIGN KEY (`tax_group_id`) REFERENCES `mage2_tax_groups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tax_group_tax_rule_pivot_tax_rule_id_foreign` FOREIGN KEY (`tax_rule_id`) REFERENCES `mage2_tax_rules` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_tax_group_tax_rule_pivot`
--

LOCK TABLES `mage2_tax_group_tax_rule_pivot` WRITE;
/*!40000 ALTER TABLE `mage2_tax_group_tax_rule_pivot` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_tax_group_tax_rule_pivot` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_tax_groups`
--

DROP TABLE IF EXISTS `mage2_tax_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_tax_groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `mage2_tax_groups`
--

LOCK TABLES `mage2_tax_groups` WRITE;
/*!40000 ALTER TABLE `mage2_tax_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_tax_groups` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_tax_rules`
--

DROP TABLE IF EXISTS `mage2_tax_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_tax_rules` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `tax_rules_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `mage2_countries` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_tax_rules`
--

LOCK TABLES `mage2_tax_rules` WRITE;
/*!40000 ALTER TABLE `mage2_tax_rules` DISABLE KEYS */;
INSERT INTO `mage2_tax_rules` VALUES (1,'NZ Tax Rule',141,NULL,'*','*',15.000000,1,'2018-02-23 10:10:32','2018-02-23 10:10:32');
/*!40000 ALTER TABLE `mage2_tax_rules` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_user_viewed_products`
--

DROP TABLE IF EXISTS `mage2_user_viewed_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_user_viewed_products` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `user_viewed_products_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_viewed_products_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `mage2_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_user_viewed_products`
--

LOCK TABLES `mage2_user_viewed_products` WRITE;
/*!40000 ALTER TABLE `mage2_user_viewed_products` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_user_viewed_products` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_users`
--

DROP TABLE IF EXISTS `mage2_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `first_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `last_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `mage2_users`
--

LOCK TABLES `mage2_users` WRITE;
/*!40000 ALTER TABLE `mage2_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mage2_visitors`
--

DROP TABLE IF EXISTS `mage2_visitors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mage2_visitors` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `mage2_wishlists` (
  ...
  CONSTRAINT `wishlists_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `mage2_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `wishlists_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `mage2_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mage2_wishlists`
--

LOCK TABLES `mage2_wishlists` WRITE;
/*!40000 ALTER TABLE `mage2_wishlists` DISABLE KEYS */;
/*!40000 ALTER TABLE `mage2_wishlists` ENABLE KEYS */;
UNLOCK TABLES;
